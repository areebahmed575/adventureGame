...
let maxEnemiesHealth = 75;
let enemyAttackDamag = 25;
let health = 100;
let attackDamage = 50;
let noOfHealthPoitions = 3;
let noOfHealthhealPoitions = 30;
let noOfPoitionsDropChance = 50;
let runnning = true;
...
while (runnning) {
    ...
    while (enemiesHealth > 0) {
        ...
        if (answer.input == "1") {
            let damageDealt = Math.floor(c * attackDamage);
            let damageTake = Math.floor(c * enemyAttackDamag);
